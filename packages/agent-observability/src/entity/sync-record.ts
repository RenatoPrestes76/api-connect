...
export class SyncRecord {
  ...
  static create(params: {
    ...
    if (params.finishedAt < params.startedAt)
      throw new SyncRecordError('finishedAt must be after startedAt');
    ...
    if (params.bytesTransferred < 0)
      throw new SyncRecordError('bytesTransferred cannot be negative');
  ...
  get startedAt(): Date {
    return this._s.startedAt;
  }
  get finishedAt(): Date {
    return this._s.finishedAt;
  }
  get durationMs(): number {
    return this._s.durationMs;
  }
  get recordsSent(): number {
    return this._s.recordsSent;
  }
  get recordsFailed(): number {
    return this._s.recordsFailed;
  }
  get bytesTransferred(): number {
    return this._s.bytesTransferred;
  }
  get compressionRatio(): number | null {
    return this._s.compressionRatio;
  }
