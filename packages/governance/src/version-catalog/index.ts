...
export interface IVersionCatalogService {
  ...
  getVersion(component: AnyComponent, version: string, componentId?: string): Promise<ComponentVersion | null>;
  ...
  deprecate(component: AnyComponent, version: string, eolAt?: Date, by?: string): Promise<GovernanceResult<void>>;
