...
export type PackageStatus       = 'draft' | 'pending' | 'in-review' | 'approved' | 'rejected' | 'published' | 'suspended' | 'deprecated';
...
export interface IPackageRegistryService {
  ...
  assignReviewer(submissionId: PackageSubmissionId, reviewerId: string, role: ReviewerRole): Promise<GovernanceResult<void>>;
  ...
  rejectSubmission(submissionId: PackageSubmissionId, reasons: string[], by: string): Promise<GovernanceResult<void>>;
  suspendPackage(packageId: RegistryPackageId, reason: string, by: string): Promise<GovernanceResult<void>>;
  deprecatePackage(packageId: RegistryPackageId, successor?: string, by?: string): Promise<GovernanceResult<void>>;
