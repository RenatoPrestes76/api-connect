...
export const CBL_ENTITY_DOMAINS: Readonly<Record<CBLEntityKind, CBLDomainKind>> = {
  PRODUCT: 'catalog',             PRODUCT_VARIANT: 'catalog',
  PRODUCT_KIT: 'catalog',         PRODUCT_BUNDLE: 'catalog',
  PRODUCT_SERVICE: 'catalog',     SUPPLIER: 'procurement',
  SUPPLIER_CONTACT: 'procurement', PURCHASE_ORDER: 'procurement',
  PURCHASE_ORDER_LINE: 'procurement', RECEIPT: 'procurement',
  RECEIPT_LINE: 'procurement',    CUSTOMER: 'crm',
  CUSTOMER_CONTACT: 'crm',        CUSTOMER_ADDRESS: 'crm',
  ORDER: 'commerce',              ORDER_LINE: 'commerce',
  ORDER_RETURN: 'commerce',       QUOTE: 'commerce',
  QUOTE_LINE: 'commerce',         INVENTORY: 'inventory',
  INVENTORY_MOVEMENT: 'inventory', INVENTORY_COUNT: 'inventory',
  WAREHOUSE: 'inventory',         WAREHOUSE_LOCATION: 'inventory',
  STOCK_TRANSFER: 'inventory',    INVOICE: 'finance',
  INVOICE_LINE: 'finance',        INVOICE_TAX: 'fiscal',
  PAYMENT: 'finance',             PAYMENT_METHOD: 'finance',
  PAYMENT_INSTALLMENT: 'finance', BANK_ACCOUNT: 'finance',
  BANK_TRANSACTION: 'finance',    ACCOUNT: 'finance',
  ACCOUNT_ENTRY: 'finance',       COST_CENTER: 'finance',
  PROFIT_CENTER: 'finance',       BUDGET: 'finance',
  CATEGORY: 'catalog',            SUBCATEGORY: 'catalog',
  BRAND: 'catalog',               ATTRIBUTE: 'catalog',
  ATTRIBUTE_VALUE: 'catalog',     UNIT_OF_MEASURE: 'catalog',
  PRICE_LIST: 'commerce',         PRICE_LIST_ITEM: 'commerce',
  DISCOUNT: 'commerce',           PROMOTION: 'commerce',
  COMPANY: 'system',              BRANCH: 'system',
  DEPARTMENT: 'hr',               EMPLOYEE: 'hr',
  EMPLOYEE_ROLE: 'hr',            ADDRESS: 'logistics',
  CARRIER: 'logistics',           DELIVERY: 'logistics',
  SHIPMENT: 'logistics',          TAX_CODE: 'fiscal',
  FISCAL_CLASSIFICATION: 'fiscal', CURRENCY: 'finance',
  EXCHANGE_RATE: 'finance',       CONTACT: 'crm',
  NOTE: 'system',                 ATTACHMENT: 'system',
  AUDIT_LOG: 'audit',
} as const;
