...
export const FIELD_PATTERNS: ReadonlyArray<{
  ...
  // ─── Generic Price ────────────────────────────────────────────────────────
  {
    patterns: ['preco', 'price', 'valor', 'value', 'vl_', 'vlr', 'amount', 'importancia', 'total'],
    role: 'PRICE',
    weight: 60,
  },
  ...
  // ─── Margin ───────────────────────────────────────────────────────────────
  {
    patterns: ['margem', 'margin', 'markup', 'lucro', 'profit', 'perc_margem', 'pct_margem'],
    role: 'MARGIN',
    weight: 88,
  },
  ...
  // ─── Quantity / Balance ───────────────────────────────────────────────────
  {
    patterns: ['saldo', 'balance', 'estoque', 'stock', 'qt_saldo', 'qtd_saldo', 'saldo_atual'],
    role: 'BALANCE',
    weight: 85,
  },
  {
    patterns: ['quantidade', 'qtd', 'qty', 'qt_', 'quantity', 'volume', 'unidade', 'unit'],
    role: 'QUANTITY',
    weight: 70,
  },
...
export const DATA_TYPE_ROLE_HINTS: ReadonlyArray<{
  ...
  {
    types: ['timestamp', 'timestamptz', 'datetime'],
    roles: ['TIMESTAMP_CREATED', 'TIMESTAMP_UPDATED', 'EXPIRY_DATE'],
    weight: 20,
  },
  {
    types: ['numeric', 'decimal', 'float', 'real'],
    roles: ['PRICE', 'QUANTITY', 'WEIGHT'],
    weight: 20,
  },
  { types: ['char', 'varchar', 'text'], roles: ['DESCRIPTION', 'NAME', 'CODE'], weight: 10 },
  {
    types: ['bigint', 'integer', 'int', 'smallint'],
    roles: ['QUANTITY', 'BALANCE', 'IDENTIFIER'],
    weight: 10,
  },
];
