...
export const ALL_ENTITY_TYPES: readonly EntityType[] = [
  'PRODUCT', 'SUPPLIER', 'CATEGORY', 'PRICE', 'INVENTORY',
  'MOVEMENT', 'SALE', 'PURCHASE', 'CUSTOMER', 'USER',
  'BRANCH', 'EXPIRY', 'LOT', 'PROMOTION', 'FISCAL',
  'LOG', 'AUDIT', 'PERMISSION', 'CONFIGURATION', 'LOOKUP',
  'UNKNOWN',
];
