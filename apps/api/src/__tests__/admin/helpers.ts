...
import { AtlasAgent, AgentStatusKind, InMemoryAtlasAgentRepository } from '@seltriva/agent-identity';
import {
...
export async function seedAgent(
  ...
  overrides: Partial<{ companyId: string; hostname: string; connectorType: string; version: string; name: string; lastHeartbeat: Date | null }> = {},
): Promise<AtlasAgent> {
