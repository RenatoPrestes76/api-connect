...
export const atlasOpenApiSpec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'REST API used by Runtime Agents to self-register, send heartbeats, report synchronisation status, and query their own identity.',
  },
    ...
    schemas: {
        ...
        properties: {
          data: {
            ...
            properties: {
              ...
              accessToken: {
                type: 'string',
                description: 'Agent Access Token — store securely, never logged.',
              },
            },
          },
        },
      ...
      HeartbeatRequest: {
        ...
        properties: {
          hostname: {
            type: 'string',
            description: 'Current hostname (optional — updates if changed).',
          },
          version: {
            type: 'string',
            description: 'Current binary version (optional — updates if newer).',
          },
        },
      },
      HeartbeatResponse: {
      ...
      SyncStatusRequest: {
        ...
        properties: {
          syncedAt: {
            type: 'string',
            format: 'date-time',
            description: 'ISO-8601 timestamp when sync completed (defaults to server time).',
          },
        },
      },
      SyncStatusResponse: {
        ...
        properties: {
          data: {
            ...
            properties: {
              ...
              status: {
                type: 'string',
                enum: ['REGISTERING', 'ONLINE', 'OFFLINE', 'SYNCING', 'ERROR', 'DISABLED'],
              },
  ...
  paths: {
    '/provision': {
      post: {
        ...
        description:
          'Validates a provisioning token, registers the agent, and returns a long-lived Agent Access Token.',
        tags: ['Atlas Agent'],
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          ...
          '403': {
            description: 'Company mismatch between token and request.',
            content: {
              'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } },
            },
          },
          ...
          '422': {
            description: 'Validation error in agent parameters.',
            content: {
              'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } },
            },
          },
    ...
    '/heartbeat': {
      post: {
        ...
        description:
          'Updates lastHeartbeat, optionally updates hostname and version, and transitions agent status to ONLINE.',
        tags: ['Atlas Agent'],
    ...
    '/sync-status': {
      post: {
        ...
        requestBody: {
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/SyncStatusRequest' } },
          },
        },
        responses: {
          '200': {
      ...
      get: {
        ...
        responses: {
          '200': {
            ...
            content: {
              'application/json': { schema: { $ref: '#/components/schemas/AgentIdentity' } },
            },
          },
          '401': {
            description: 'Missing or invalid agent token.',
