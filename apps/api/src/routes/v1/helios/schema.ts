...
export function registerSchemaRoutes(router: Router): void {
  router.get('/api/v1/helios/schema', async (ctx: RouteContext, res: ServerResponse) => {
  ...
  router.get(
    '/api/v1/helios/schema/:id/versions',
