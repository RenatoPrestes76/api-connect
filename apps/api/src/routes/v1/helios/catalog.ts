...
export function registerCatalogRoutes(router: Router): void {
  router.get('/api/v1/helios/catalog', async (ctx: RouteContext, res: ServerResponse) => {
  ...
  router.get('/api/v1/helios/catalog/:id', async (ctx: RouteContext, res: ServerResponse) => {
