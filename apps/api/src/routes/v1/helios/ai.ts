...
export function registerEventAIRoutes(router: Router): void {
  router.get('/api/v1/helios/ai/insights', async (ctx: RouteContext, res: ServerResponse) => {
  ...
  router.get('/api/v1/helios/ai/forecast', async (ctx: RouteContext, res: ServerResponse) => {
