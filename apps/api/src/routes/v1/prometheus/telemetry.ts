...
export function registerTelemetryRoutes(router: Router): void {
  router.get('/api/v1/telemetry/overview', async (_ctx: RouteContext, res: ServerResponse) => {
    json(res, prometheusStore.getTelemetryOverview());
  });

  router.get('/api/v1/telemetry/traces', async (ctx: RouteContext, res: ServerResponse) => {
  ...
  router.get('/api/v1/telemetry/traces/:id', async (ctx: RouteContext, res: ServerResponse) => {
  ...
  router.get('/api/v1/telemetry/service-map', async (_ctx: RouteContext, res: ServerResponse) => {
