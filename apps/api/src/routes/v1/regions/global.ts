...
export function registerGlobalRoutes(router: Router): void {
  // GET /api/v1/global/overview
  router.get('/api/v1/global/overview', async (_ctx: RouteContext, res: ServerResponse) => {
    json(res, regionsStore.getGlobalOverview());
  });

  // GET /api/v1/global/replication
  router.get('/api/v1/global/replication', async (ctx: RouteContext, res: ServerResponse) => {
  ...
  router.get('/api/v1/global/events', async (ctx: RouteContext, res: ServerResponse) => {
