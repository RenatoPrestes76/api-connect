...
export function HealthIndicator({
  status, label, showLabel = true, size = 'md', className,
...
export function MetricGauge({ label, value, max, unit = '%', status = 'healthy' }: MetricGaugeProps) {
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex justify-between text-xs">
        ...
        <span className="tabular text-slate-500">{value}{unit} / {max}{unit}</span>
      </div>
