...
const ICONS: Record<string, typeof LayoutDashboard> = {
  ...
  '/portal/gateway/rate-limits': Gauge,
  '/portal/gateway/settings': Settings,
  '/portal/gateway/logs': FileText,
  '/portal/health': HeartPulse,
  '/release': Rocket,
...
const LABELS: Record<string, string> = {
  ...
  '/portal/gateway/rate-limits': 'Limites de Requisição',
  '/portal/gateway/settings': 'Config. do Gateway',
  '/portal/gateway/logs': 'Logs de API',
  '/portal/health': 'Saúde da Plataforma',
